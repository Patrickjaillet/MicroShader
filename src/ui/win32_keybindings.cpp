...
Win32Keybindings default_win32_keybindings()
{
    ...
    bindings.save_file_as = Win32KeyChord{ 'S', true, true, false };
...
Win32Keybindings load_win32_keybindings()
{
    ...
    bindings.save_file_as = load_one(text, "save_file_as", fallback.save_file_as);
...
void save_win32_keybindings(const Win32Keybindings& bindings)
{
    ...
    save_one(out, "save_file_as", bindings.save_file_as, true);
