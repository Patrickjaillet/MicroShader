...
void import_exclude_list_action(std::string& protected_names, HWND window)
{
    std::optional<std::string> path = show_open_file_dialog_hwnd(window, kExcludeListFilter, L"txt");
    if (path.has_value())
    {
